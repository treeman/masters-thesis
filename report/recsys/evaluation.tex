...
Recommendation quality is evaluated using \textit{Precision}, \textit{Recall} and \textit{F-measure} with top-10 recommendations, as described in \sectionref{sec:background:eval}. Focus is on \textit{F-measure} as a combined measure of \textit{Precision} and \textit{Recall}.

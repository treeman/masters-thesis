...
\footnote{\textit{katz-eig} models this way, see \sectionref{sec:background:theory:katzeig}}.
...
\citep{norvigAI}. This will be explained further in \sectionref{sec:background:theory:opt}.

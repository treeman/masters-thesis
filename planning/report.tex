...
Comordo has access to data from Adlibris, Readly and as the project goes on more data may become available.

The Readly dataset has approximately 8300 users, 700 items and 200 000 elements in the purchase history.

The Adlbris dataset has approximately 75000 users, 350 000 items with 2 000 000 elemens in the purchase history, after filtering away users with less than 2 bought items.
